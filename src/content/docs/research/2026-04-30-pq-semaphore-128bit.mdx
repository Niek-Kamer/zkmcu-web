...
<Aside type="caution" title="Draft, writeup in progress">
  This page is the technical writeup for the five-phase 128-bit security build of PQ-Semaphore. The benchmark numbers, the security argument, and the firmware crates are real and reproducible from `reproduce.sh`. The prose framing is being drafted; expect edits before this leaves draft.
</Aside>
...
**Verdict.** This is the first published dual-hash FRI verification with hash-tower soundness composition that I've found, on any hardware platform, on or off MCU. Prior-art search trail at [`research/notebook/2026-04-30-prior-art-stark-side.md`](https://github.com/Niek-Kamer/zkmcu/blob/main/research/notebook/2026-04-30-prior-art-stark-side.md). If you know of earlier work, [tell me](/contact/) and I'll update.
...
Full audit-boundary writeup is at [`research/notebook/2026-04-30-security-claim-table.md`](https://github.com/Niek-Kamer/zkmcu/blob/main/research/notebook/2026-04-30-security-claim-table.md).
...
- [`benchmarks/runs/2026-04-30-m33-pq-semaphore-dual/`](https://github.com/Niek-Kamer/zkmcu/tree/main/benchmarks/runs/2026-04-30-m33-pq-semaphore-dual/)
- [`benchmarks/runs/2026-04-30-rv32-pq-semaphore-dual/`](https://github.com/Niek-Kamer/zkmcu/tree/main/benchmarks/runs/2026-04-30-rv32-pq-semaphore-dual/)
...
- Audited Poseidon2 round constants from [`crates/zkmcu-poseidon-audit`](https://github.com/Niek-Kamer/zkmcu/tree/main/crates/zkmcu-poseidon-audit) (in-tree audit crate).
...
- Bench artifacts: [`benchmarks/runs/2026-04-{29,30}-*`](https://github.com/Niek-Kamer/zkmcu/tree/main/benchmarks/runs/) per phase.
