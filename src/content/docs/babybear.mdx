...
<div class="hero-badges">
  ...
  <Badge text="BabyBear × Quartic" variant="note" />
  <Badge text="95-bit conjectured security" variant="note" />
  <Badge text="cross-ISA gap 1.04×" variant="success" />
  <Badge text="variance 0.053 % on Hazard3" variant="success" />
  <Badge text="Goldilocks still wins on latency" variant="caution" />
</div>
