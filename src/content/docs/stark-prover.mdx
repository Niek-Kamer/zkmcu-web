...
N=512 at blowup=4 needs ~600 KB heap for the LDE matrix and FRI oracle data. The RP2350 has 512 KB total SRAM. Even if you stripped everything else out, that's just not enough. N=256 is the practical limit on this chip at these parameters, regardless of which field you pick.
</Aside>
